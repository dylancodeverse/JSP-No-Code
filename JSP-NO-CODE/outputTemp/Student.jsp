                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card w-100">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table text-nowrap mb-0 align-middle">
                                            <thead class="text-dark fs-4">
                                                ...
                                                <% Page<Student> student = (Page<Student>) request.getAttribute("students");
                                                int currentPage = student.getNumber();
                                                int totalPages = student.getTotalPages();
                                                ...
                                                <td class="border-bottom-0"><h6 class="fw-semibold mb-0"><%= student.getId() %></h6></td>
                                                        ...
                                                        <td class="border-bottom-0"><%= student.getId() %></td>
                                                        <td class="border-bottom-0"><%= student.getName() %></td>
                                                        <td class="border-bottom-0"><%= student.getFirst_name() %></td>
                                                        <td class="border-bottom-0"><%= student.getBirthdate() %></td>
                            ...
                            <a href="/students/add">Add New #Entity#</a>
                        </div>
                    </div>
                </div>
            </div>
